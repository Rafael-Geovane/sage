    ...
    public function run(): void
    {
        ...
        DB::table('usuario')->insert([
            [
                ...
                'email' => 'maria.santos@email.com', 'senha_hash' => bcrypt('user123'), 'nome_plano' => 'Premium',
            ...
            [
                ...
                'email' => 'joao.oliveira@email.com', 'senha_hash' => bcrypt('user123'), 'nome_plano' => 'HaaS',
            ...
            [
                ...
                'email' => 'helena.costa@email.com', 'senha_hash' => bcrypt('user123'), 'nome_plano' => 'Básico',
            ...
            [
                ...
                'email' => 'antonio.rocha@email.com', 'senha_hash' => bcrypt('user123'), 'nome_plano' => 'Premium',
                'notificar_push' => true, 'notificar_sms' => true, 'notificar_ligacao' => true,
                'id_admin_responsavel' => 2,
            ],
            [
                ...
                'email' => 'zilda.nunes@email.com', 'senha_hash' => bcrypt('user123'), 'nome_plano' => 'HaaS',
